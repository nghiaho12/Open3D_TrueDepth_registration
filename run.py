...
if __name__ == "__main__":
    ...
    parser.add_argument('--min_depth', default=0.1, help='min depth distance (meters)')
    parser.add_argument('--max_depth', default=0.5, help='max depth distance (meters)')
    parser.add_argument('--distance_threshold', default=0.01, help='for ICP (meters)')
